...
| ollama                 | https://github.com/ollama/ollama                         | 运行基座             |
| MiniCPM-V              | https://github.com/OpenBMB/MiniCPM-V                     | 多模态大模型           |
| Meditron               | https://github.com/epfLLM/meditron                       | 基于ollama的医学大语言模型 |
|                        |                                                          |                  |
## 文本处理
...
| name                         | link                                                     |           |
| ---------------------------- | -------------------------------------------------------- | --------- |
| Agently-Daily-News-Collector | https://github.com/AgentEra/Agently-Daily-News-Collector | 新闻汇总报告生成器 |
...
| ControlNet       | https://github.com/lllyasviel/ControlNet      | 敏神做的SD插件         |
| ComfyUI          | https://github.com/comfyanonymous/ComfyUI     |                  |
| StableCascade    | https://github.com/Stability-AI/StableCascade |                  |
| T2V-NPR          | https://github.com/exadel-inc/CompreFace      | 从文本生成高质量的矢量图形和动画 |
| IC-Light         | https://github.com/lllyasviel/IC-Light        | 敏神做的AI打光神器       |
|                  |                                               |                  |
## 图片处理

| name    | link                                    |          |
| ------- | --------------------------------------- | -------- |
| rembg   | https://github.com/danielgatis/rembg    | 一键批量智能抠图 |
| vtracer | https://github.com/visioncortex/vtracer | 图片转矢量    |

# 视频生成和处理 Video generation

| name         | link                                       |            |
| ------------ | ------------------------------------------ | ---------- |
| SoraWebui    | https://github.com/SoraWebui/SoraWebui     |            |
| Open-Sora    | https://github.com/hpcaitech/Open-Sora     |            |
| V-Express    | https://github.com/tencent-ailab/V-Express | 照片开口唱歌     |
| DeepFaceLive | https://github.com/iperov/DeepFaceLive     | 视频通话实时换脸   |
| Chenyme-AAVT | https://github.com/Chenyme/Chenyme-AAVT    | 视频翻译       |
| ToonCrafter  | https://github.com/ToonCrafter/ToonCrafter | 生成视频中间帧    |
| faceswap     | https://github.com/deepfakes/faceswap      | 视频换脸       |
| AnimateDiff  | https://github.com/guoyww/animatediff      | SD上流行的视频插件 |
## 视频识别

| name       | link                                     |           |
| ---------- | ---------------------------------------- | --------- |
| CompreFace | https://github.com/exadel-inc/CompreFace | 人脸识别      |
| yolov10    | https://github.com/THU-MIG/yolov10       | 毫秒级视频目标检测 |
## 视频剪辑AI Video clips
...
| FunClip           | https://github.com/alibaba-damo-academy/FunClip | 阿里达摩院开源的AI剪辑工具 |
...
| Flowise  | https://github.com/FlowiseAI/Flowise   | LLM开源低代码工具、可视化LangChain、可定制AI Agent  |
...
| name  | link                                                                                      |
| ----- | ----------------------------------------------------------------------------------------- |
| cat3d | [CAT3D: Create Anything in 3D with Multi-View Diffusion Models](https://cat3d.github.io/) |
|       |                                                                                           |
...
| name          | link                                              |          |
| ------------- | ------------------------------------------------- | -------- |
| ViViD         | https://github.com/alibaba-yuanjing-aigclab/ViViD | AI虚拟试衣间  |
| ChatGPT-On-CS | https://github.com/cs-lazy-tools/ChatGPT-On-CS    | 智能对话客服工具 |
